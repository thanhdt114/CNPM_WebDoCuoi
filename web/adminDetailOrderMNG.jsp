            ...
            <td style="padding-top: 90px; padding-bottom: 50px; vertical-align: top;" >
                <div class='edit-ad'>
                    ...
                    <tr>
                        ...
                        <th class="col-edit">ID Order</th>
                        <th class="col-edit">ID Product</th>
                        <th class="col-edit">Số lượng</th>
                        <th class="col-edit">Đơn giá</th>
                    </tr>
                    <c:forEach var ="item" items="${listDetailOrders}">
                        <tr>
                            <td class="col-edit">${item.getIDDetailOrder()}</td>
                            <td class="col-edit">${item.getIDOrder()}</td>
                            <td class="col-edit">${item.getIDProd()}</td>
                            <td class="col-edit">${item.getSoLuong()}</td>
                            <td class="col-edit">${item.getDonGia()}</td>
                        </tr>
                    </c:forEach>
            ...
            <td style="vertical-align: top;">
                    <div class="btn-admin-b">
                        <button class="btn-admin btn-admin1" type="submit" value="Submit">
                            <i class="fa icon-nav">&#xf0c7;</i>Thanh toán
                        </button>
