    ...
    <table>
        <tr>
            ...
            <td style="padding-top: 90px; padding-bottom: 50px; vertical-align: top;" >
                <div class='edit-ad'>
                    <h2>Danh sách đơn hàng:</h2> <br>
                    
                    <table class="tb-edit">
                    <tr>
                        <th class="col-edit">ID</th>
                        <th class="col-edit">Email</th>
                        <th class="col-edit">Tên người đặt</th>
                        <th class="col-edit">Địa chỉ</th>
                        <th class="col-edit">Số điện thoại</th>
                        <th class="col-edit">Ngày đặt</th>
                        <th class="col-edit">Thành tiền</th>
                    ...
                    <c:forEach var ="item" items="${listOrders}">
                        <tr>
                            ...
                            <td class="col-edit">${item.getEmail()}</td>
                            <td class="col-edit">${item.getTenNguoiNhan()}</td>
                            <td class="col-edit">${item.getDiaChi()}</td>
                            <td class="col-edit">${item.getSoDienThoai()}</td>
                            <td class="col-edit">${item.getNgayDatHang()}</td>
                            <td class="col-edit">${item.getThanhTien()}</td>
                            <td class="col-edit">${item.getTinhtrang()}</td>
                            <td class="col-edit">
                                <a href="DetailOrderMNGCtrl?idOrder=${item.getIDOrder()}">
