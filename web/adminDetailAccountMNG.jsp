            ...
            <tr>
                ...
                <td style="padding-top: 90px; padding-bottom: 50px; vertical-align: top; width: 600px;" >
                    <div class='edit-ad' style="position: unset;">
                        <h2>Chi tiết tài khoản: ${account.getIDAccount()}</h2> <br>

                        <div class="form-detail">
                        <form>
                            <input type="hidden" name="idAccount" value=${account.getIDAccount()}>
                            
                            <label for="fname">Email: ${account.getEmail()}</label>
                            <input type="text" id="fname" name="email" placeholder=${account.getEmail()}>

                            <label for="lname">Username: ${account.getUserName()}</label>
                            <input type="text" id="lname" name="username" placeholder=${account.getUserName()}>

                            <label for="lname">Password: ***</label>
                            <input class="pw_admin" type="password" id="lname" name="password" placeholder=***>

                            <label for="lname">Quyền: ${account.getQuyen()}</label>
                            <input type="text" id="lname" name="quyen" placeholder=${account.getQuyen()}>
                        </form>
                      </div>
                ...
                <td style="vertical-align: top;">
                    ...
                    <div class="detailProduct-img">
                        <img src="https://lh3.google.com/u/0/d/1RG7HHE8PUGSZSNivVLPKEpmvI5zjVzIm=w1842-h953-iv1" alt="alt"/>
                    </div>
                </td>
            </tr>
        </table>
