            ...
            <td style="padding-top: 90px; padding-bottom: 50px; vertical-align: top;" >
                <div class='edit-ad' style="position: unset;">
                    ...
                    <tr>
                        ...
                        <th class="col-edit">UserName</th>
                        <th class="col-edit">Password</th>
                        <th class="col-edit">Quyền</th>
                        <th class="col-edit">Chi tiết</th>
                    </tr>
                    <c:forEach var ="item" items="${listAccounts}">
                        <tr>
                            <td class="col-edit">${item.getIDAccount()}</td>
                            <td class="col-edit">${item.getEmail()}</td>
                            <td class="col-edit">${item.getUserName()}</td>
                            <td class="col-edit">***</td>
                            <td class="col-edit">${item.getQuyen()}</td>
                            <td class="col-edit">
                                <a href="DetailAccountMNGCtrl?idAccount=${item.getIDAccount()}">
