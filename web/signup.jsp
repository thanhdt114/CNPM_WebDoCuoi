...
<html lang="vi">
    ...
    <body>
        ...
        <div class="login-body" style="background-image: url('images/login_background_2.png');">
            <!--Đăng Nhập-->
            <div class="login-position" style="margin-left: 450px; width: 600px;" >
                <form class="form-login" action="LoginCtrl?iDProd=${param.iDProd}" method="post"  style="margin-top: 20px; width: 600px;">
                    ...
                    <div class="container-login">  
                        <div class="d_username"> 
                            <label class="lableInput"><b>Email</b></label>
                            <input type="username" placeholder="Nhập email" name="username" requied> 
                        </div>
                        ...
                        <div class="d_password"> 
                            <label class="lableInput"><b>Xác nhận Mật khẩu</b></label> 
                            <input type="password" placeholder="Nhập mật khẩu" name="password" requied>
                        </div>
