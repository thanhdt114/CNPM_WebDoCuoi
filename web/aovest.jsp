		...
		<div class="container">
			<div class="flex-w flex-sb-m p-b-52">
				<div class="flex-w flex-l-m filter-tope-group m-tb-10">
                                        <a href="CategoryCtrlAoVest#Hinh"><button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter="*" style="font-family: Roboto;">
						Tất cả
                                            </button></a>

					<a href="AovestCtrlA#Hinh"><button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".women" style="font-family: Roboto;">
						Áo vest
                                            </button></a>

					<a href="AovestCtrlQ#Hinh"><button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".men" style="font-family: Roboto;">
						Quần vest
                                            </button></a>
				...
				<div class="dis-none panel-search w-full p-t-10 p-b-15">
					<form action="SearchAV" method="post">
			...
			<div class="row isotope-grid" id="Hinh">
                        <c:forEach var ="item" items="${VestAo}">
                    ...
                    <c:forEach var ="item" items="${VestQuan}">
                           <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					<!-- Block2 -->
					<div class="block2">
						<div class="block2-pic hov-img0">
